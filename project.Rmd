...
```{r load_data}
trainingdata <- read.csv('C:/Users/isak.rabin/Documents/Personal/Coursera/PML/pml-training.csv', na.strings=c('','NA','#DIV/0!'))
...
# Read Test Dataset
testingset <- read.csv('C:/Users/isak.rabin/Documents/Personal/Coursera/PML/pml-testing.csv', na.strings=c('','NA','#DIV/0!'))
